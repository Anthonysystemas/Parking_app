...
/// Crea interfaz reserva estacionamiento Flutter:
///
/// HEADER:
/// - AppBar con título "Reservar Estacionamiento"
/// - Botón back + ícono favorito
///
/// BODY:
/// - Imagen del estacionamiento (height 200px)
/// - Card info principal:
///   * Nombre + rating estrellas
///   * Dirección con ícono ubicación
///   * Precio por hora destacado
///
/// - Sección "Seleccionar fecha y hora":
///   * DatePicker horizontal (hoy, mañana, etc)
///   * TimePicker: hora inicio y fin
...
///
/// BOTTOM:
/// - Botón "Reservar Ahora" fijo (color turquesa)
///
/// COLORES:
/// - Primario: #00BFA5
/// - Texto: #2E2E2E
        ...
        body: SafeArea(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Image.network(
                  'https://images.unsplash.com/photo-1757821135261-5f3cbfb1f98d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NTgyMzU0Nzd8&ixlib=rb-4.1.0&q=80&w=1080',
                  width: double.infinity,
                  height: 200.0,
                  fit: BoxFit.cover,
                ),
