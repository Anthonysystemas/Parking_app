...
export '/registrarsesion/registrarsesion_widget.dart'
    show RegistrarsesionWidget;
export '/onboarding02/onboarding02_widget.dart' show Onboarding02Widget;
export '/mapa_estacionamiento/mapa_estacionamiento_widget.dart'
    show MapaEstacionamientoWidget;
...
export '/reservar_parking/reservar_parking_widget.dart'
    show ReservarParkingWidget;
