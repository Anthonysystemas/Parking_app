...
/// Crea página inicio Flutter app estacionamiento:
///
/// HEADER:
/// - Gradiente verde-turquesa, altura 280px
/// - Row: ubicación "Av.
///
/// La Marina 890" + notificaciones
/// - Título: "Encuentra el mejor espacio de estacionamiento" (blanco, bold)
///
/// BODY (fondo blanco, borderRadius 32px):
/// - Barra búsqueda: height 56px, ícono search + TextField + ícono mapa (GPS)
/// - "Ubicaciones recientes":
///   * ListTile con ícono "P" cuadrado turquesa
///   * Título: "Centro Comercial Plaza Norte"
///   * Trailing: ícono flecha derecha
///
/// BOTTOM NAV (fondo oscuro):
/// - 5 items: Inicio(activo/turquesa), Calendario, Botón central
/// ">>"(turquesa), Compartir, Perfil
///
/// COLORES:
/// - Primario: #00BFA5
/// - Texto: #2E2E2E
/// - Gris: #9E9E9E
///
/// Padding 24px, borderRadius 16px, sombras suaves
///
/// NAVEGACIÓN:
/// - Ícono mapa en búsqueda: onTap navega a MapScreen()
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      context.pushNamed(
                                          MapaEstacionamientoWidget.routeName);
                                    },
                                  ),
